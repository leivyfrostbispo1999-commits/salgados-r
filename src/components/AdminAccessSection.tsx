    ...
    <section id="sistema" className="scroll-mt-24 bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-6 rounded-lg border border-zinc-100 bg-[#F5F5F5] p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[var(--sr-red)]">Area administrativa</p>
            <h2 className="mt-2 text-3xl font-black tracking-tight text-[var(--sr-black)]">Sistema operacional da loja</h2>
          ...
          <a
            href="/admin"
            className="rounded-full bg-[var(--sr-black)] px-6 py-4 text-center text-sm font-black text-white transition hover:bg-[var(--sr-red)]"
          >
            Entrar no painel
          </a>
        </div>
