...
export function OfficialMenu() {
  return (
    <section id="cardapio-oficial" className="scroll-mt-24 bg-[#F5F5F5] py-16 text-[#1D1D1D]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-2">
          {menuImages.map((image) => (
            <a key={image.src} href={image.src} target="_blank" rel="noreferrer" className="group rounded-lg bg-white p-3 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
