      ...
      <div className="mx-auto grid min-h-[560px] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.92fr]">
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <span className="rounded-full bg-white/15 px-4 py-2 text-sm font-black text-white">suco natural gelado</span>
          </div>
        </div>
...
function CategoryStripHome() {
  return (
    <section className="bg-[linear-gradient(90deg,#FFC72C,#FFD21F,#FF8A00)] py-7">
        ...
        <div className="flex min-w-max gap-3">
          {categories.map((category) => (
            <a
              key={category.label}
              href={category.href}
              className="group flex min-w-32 items-center gap-3 rounded-2xl border border-[#9B000B]/10 bg-[#9B000B] px-4 py-3 text-white shadow-[0_18px_34px_rgba(110,0,8,0.20)] transition hover:-translate-y-0.5 hover:bg-[#6E0008] hover:shadow-md focus:outline-none focus:ring-4 focus:ring-white/50"
            >
              <span className="grid h-12 w-12 place-items-center rounded-2xl bg-[#FFD21F] text-lg font-black text-[#9B000B]">
                {category.mark}
              </span>
...
function FeaturedHome() {
  return (
    <section className="sr-hot-bg py-14 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.16em] text-[#FFD21F]">Mais pedidos</p>
            <h2 className="mt-2 text-4xl font-black tracking-tight text-white">Favoritos da Salgados R</h2>
          </div>
          <a href="/cardapio" className="font-black text-[#FFD21F] underline decoration-white/35 decoration-4 underline-offset-4">
            Ver todos
          </a>
        </div>
...
function HowItWorksHome() {
  return (
    <section id="como-pedir" className="scroll-mt-24 bg-[#FFC72C] py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
...
function RefillBannerHome() {
  return (
    <section id="refil" className="scroll-mt-24 bg-[#FFC72C] pb-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid gap-5 overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#6E0008,#DA291C_58%,#FF8A00)] p-6 text-white shadow-[0_24px_60px_rgba(110,0,8,0.28)] sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.16em] text-[#FFD21F]">Refil de sucos naturais</p>
            <h2 className="mt-2 text-3xl font-black tracking-tight text-white">A partir de R$ 4,00.</h2>
          ...
          <a href="/cardapio?categoria=refil" className="rounded-2xl bg-[#FFD21F] px-6 py-4 text-center font-black text-[#111111] shadow-[0_18px_34px_rgba(255,210,31,0.32)] transition hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-white/70">
            Ver opcoes
          </a>
        </div>
      </div>
