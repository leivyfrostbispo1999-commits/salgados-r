...
const productVisuals: Record<string, { imageUrl: string; imageAlt: string; badge: string }> = {
  ...
  'suco-natural-garrafinha-300ml': {
    imageUrl: '/assets-reais/refil-sucos-v2.png',
    ...
    <div className="min-h-screen bg-[var(--sr-red)] text-[var(--sr-white)]">
      ...
      <main className="bg-[var(--sr-red)] py-5 sm:py-7">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-5 flex flex-col gap-4 rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-4 text-[var(--sr-white)] sm:flex-row sm:items-center sm:justify-between sm:p-5">
            <div>
          ...
          {loading ? <p className="rounded-2xl border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 font-black">Carregando cardapio...</p> : null}
  ...
  return (
    <div className="grid min-w-0 gap-6 overflow-hidden lg:grid-cols-[minmax(0,1fr)_340px]">
      <div className="grid min-w-0 gap-8">
        <section className="min-w-0 overflow-hidden rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-4 text-[var(--sr-white)] sm:p-5">
          <div className="mb-4 grid min-w-0 gap-3 overflow-hidden rounded-[1.25rem] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)] sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
            ...
            <a href="/cardapio-oficial" className="w-full rounded-full border-2 border-[var(--sr-yellow)] px-5 py-3 text-center text-sm font-black text-[var(--sr-white)] transition hover:bg-[var(--sr-yellow)] hover:text-[var(--sr-red)] focus:outline-none focus:ring-4 focus:ring-[var(--sr-yellow)] sm:w-auto">
          ...
          <div className="grid min-w-0 gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            <input
              ...
              className="min-h-12 rounded-full border-2 border-[var(--sr-yellow)] bg-[var(--sr-white)] px-5 py-4 text-sm font-bold text-[var(--sr-red)] outline-none transition placeholder:text-[var(--sr-red)] focus:border-[var(--sr-yellow)] focus:ring-4 focus:ring-[var(--sr-yellow)]"
            />
      ...
      <aside className="hidden h-fit rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 lg:sticky lg:top-24 lg:block">
...
function CartView({
  ...
  return (
    <div className="grid gap-5 pb-24 lg:grid-cols-[1fr_320px] lg:pb-0">
      <section className="rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)]">
        ...
        <div className="mt-4 grid gap-4">
          ...
          {cart.map((item) => (
            <article key={item.product.id} className="rounded-2xl border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-4">
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-[160px_1fr]">
                <div className="flex items-center justify-between rounded-full bg-[var(--sr-white)] p-1 text-[var(--sr-red)]">
                  <button
                    type="button"
                ...
                <input
                  ...
                  className="rounded-xl border-2 border-[var(--sr-yellow)] bg-[var(--sr-white)] px-3 py-3 font-semibold text-[var(--sr-red)] outline-none placeholder:text-[var(--sr-red)] focus:border-[var(--sr-yellow)] focus:ring-4 focus:ring-[var(--sr-yellow)]"
                />
              </div>
            </article>
          ))}
      ...
      <aside className="hidden h-fit rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)] lg:block">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 border-t-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-4 text-[var(--sr-white)] lg:hidden">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
          <div>
            <p className="text-xs font-black uppercase tracking-wide text-[var(--sr-yellow)]">Total</p>
            <p className="text-xl font-black text-[var(--sr-white)]">{formatCurrency(total)}</p>
          </div>
          <a
            href={cart.length ? '/checkout' : '/cardapio'}
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[1fr_360px]">
      <section className="rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)]">
        ...
        <h2 className="mt-5 text-3xl font-black text-[var(--sr-white)]">Checkout</h2>
        ...
        {form.paymentMethod === 'dinheiro' ? (
          <div className="mt-4 grid gap-3 rounded-2xl bg-[var(--sr-white)] p-4 text-[var(--sr-red)] sm:grid-cols-[auto_1fr] sm:items-center">
      ...
      <aside className="h-fit rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)] lg:sticky lg:top-20">
        ...
        <div className="mt-5 space-y-2 border-t-2 border-[var(--sr-yellow)] pt-4 text-sm font-bold">
...
function SuccessView({ order }: { order: ApiOrder | null }) {
  if (!order) {
    return (
      <section className="rounded-lg border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)]">
  ...
  return (
    <section className="mx-auto max-w-2xl rounded-lg border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-6 text-center text-[var(--sr-white)]">
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2">
        <a href={buildOrderWhatsAppUrl(order)} target="_blank" rel="noreferrer" className="rounded-full bg-[var(--sr-yellow)] px-5 py-4 font-black text-[var(--sr-red)]">
          Enviar pedido pelo WhatsApp
        </a>
        <a href="/cardapio" className="rounded-full border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] px-5 py-4 font-black text-[var(--sr-white)]">
          Fazer outro pedido
        </a>
      </div>
    </section>
...
function FloatingCart({ count, total }: { count: number; total: number }) {
  return (
    ...
    >
      ...
      <span className="rounded-full bg-[var(--sr-yellow)] px-3 py-1 text-[var(--sr-red)]">Ver</span>
    </a>
  )
}
...
function JuiceRules() {
  return (
    <div className="mb-4 grid gap-3 md:grid-cols-2">
      <div className="rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-4 text-[var(--sr-white)]">
...
function RefillRules() {
  return (
    <div className="mb-4 overflow-hidden rounded-[22px] border-2 border-[var(--sr-yellow)] bg-[var(--sr-red)] p-5 text-[var(--sr-white)]">
